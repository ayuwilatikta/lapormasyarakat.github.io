...
if (isset($_POST["submit"])) {
    ...
    if($update){
        echo "<script>alert('Data Berhasil Diedit');document.location.href='history.php'</script>";
    }else{
        echo "<script>alert('Data Gagal Diedit');document.location.href='edit.php?id_laporan='$id_laporan''</script>";
    }
}
