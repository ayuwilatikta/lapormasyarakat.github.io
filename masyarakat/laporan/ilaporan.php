      ...
      if (isset($_POST['submit'])) {
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($foto["tmp_name"], $target_file)) {
                $sql = "INSERT INTO laporan (id_pengguna, kategorilapor, isi_lapor, foto, id_kat_bencana,id_ref_lembaga,statuslap)
                VALUES ('".$_SESSION['id_pengguna']."', '".$kategorilapor."', '".$isi_lapor."', '".$namafile."', '".$id_kat_bencana."', '".$id_ref_lembaga."', 'proses')";
                // echo $sql;
