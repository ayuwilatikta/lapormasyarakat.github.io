<?php
require 'guest/database/koneksi.php';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="guest/assets/vendors/mdi/css/materialdesignicons.min.css">
  <link rel="stylesheet" href="guest/assets/vendors/css/vendor.bundle.base.css">
  <!-- endinject -->
  ...
  <!-- End layout styles -->
  <link rel="shortcut icon" href="guest/assets/images/favicon.ico" />
</head>
...
<body>
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color:mediumblue;">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav" style="margin-left:100px">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="guest/static-page/tentang-kami.php">Tentang Kami</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="guest/static-page/contact.php">Contact</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="guest/static-page/faq.php">FAQ</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="guest/static-page/ketentuan-penggunaan.php">Ketentuan Penggunaan</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="guest/static-page/kebijakan-privasi.php">Kebijakan Privasi</a>
        </li>
        <li class="nav-item">
          ...
          <div class="card-body">
            <div class="card-body">
              ...
              while ($row = mysqli_fetch_array($query3)) { ?>
                <ul>
                  <li>
                    <img src="guest/assets/images/sosial.jpg" alt="" width="70px" width="70px">
              ...
              while ($row = mysqli_fetch_array($query4)) { ?>
                <ul>
                  <li>
                    <img src="guest/assets/images/tech.jpg" alt="" width="70px" width="70px">
  ...
  <script src="guest/assets/vendors/js/vendor.bundle.base.js"></script>
  <!-- endinject -->
  <!-- Plugin js for this page -->
  <!-- End plugin js for this page -->
  <!-- inject:js -->
  <script src="guest/assets/js/off-canvas.js"></script>
  <script src="guest/assets/js/hoverable-collapse.js"></script>
  <script src="guest/assets/js/misc.js"></script>
  <!-- endinject -->
