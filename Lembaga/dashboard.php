          ...
          <div class="card-body">
            ...
            <div class="row mt-3">
              <div class="col-6 pr-1">
                <img src="assets/images/dashboard/banjirbandang.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                <img src="assets/images/dashboard/jalanrusak.jpg" class="mw-100 w-100 rounded" alt="image">
              </div>
              <div class="col-6 pl-1">
                <img src="assets/images/dashboard/kebakaranhutan.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                <img src="assets/images/dashboard/putingbeliung.jpg" class="mw-100 w-100 rounded" alt="image">
              </div>
            </div>
