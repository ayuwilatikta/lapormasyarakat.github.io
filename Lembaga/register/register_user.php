          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              <div class="brand-logo">
                <h3 class="text-center">Registrasi Lembaga</h3>
              </div>
              <h4>Buat Akun Baru</h4>
              <h6 class="font-weight-light">Silahkan Isi Dengan Lengkap Kolom-Kolom Berikut : </h6>
              <form class="pt-3" method="post" action="pregister_user.php">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="telp" placeholder="telp">
                </div>
                <div class="form-group">
                  <input type="hidden" class="form-control form-control-lg" name="statusp" placeholder="statusp" value="3">
                </div>
                <div class="mb-4">
                ...
                <div class="text-center mt-4 font-weight-light"> Sudah memiliki akun? <a href="../login/login.php" class="text-primary">Login</a>
                </div>
              </form>
            </div>
          </div>
