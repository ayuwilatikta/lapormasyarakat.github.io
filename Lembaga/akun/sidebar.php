  ...
  <nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
      <li class="nav-item nav-profile">
        <a href="http://localhost/lembaga/akun/akun.php" class="nav-link">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="http://localhost/lapor/Lembaga/daftarpengaduan.php">Kelola Komentar</a></li>
            <li class="nav-item"> <a class="nav-link" href="http://localhost/lapor/Lembaga/lapsarana/lapsarana.php">Kelola Laporan</a></li>
