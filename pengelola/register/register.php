              ...
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" method="post" action="pregister.php" >
                  <div class="form-group">
                    <input type="text" class="form-control form-control-lg" name="id_pengguna" placeholder="id_pengguna">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <select class="form-control form-control-lg" name="statusp">
                      <option>Statusp</option>
                      <option>1</option>
                      <option>2</option>
                    </select>
                  </div>
                  ...
                  <div class="text-center mt-4 font-weight-light"> Already have an account? <a href="http://localhost/pengelola/login/login.php" class="text-primary">Login</a>
                  </div>
                </form>
              </div>
            </div>
