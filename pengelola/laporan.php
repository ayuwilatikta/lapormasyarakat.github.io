       ...
       <div class="col-lg-12 stretch-card">
         <div class="card">
           <div class="card-body">
             ...
             <a class="btn btn-gradient-primary btn-fw" href="http://localhost/lapor/pengelola/tambahlaporan.php">Tambah</a>
            <table class="table table-bordered">
              ...
              <tbody>
                <tr class="table-warning">
                  ...
                  <td> <img src='../gambar/laporan/<?php echo $row['foto']; ?>' width="200" height="auto"> </td>
                  <td> <?php echo $row["id_kat_bencana"]; ?> </td>
                  <td> <?php echo $row["id_ref_lembaga"]; ?> </td>
                  <td>
                  <a href="editlaporan.php?id_laporan=<?php echo $row['id_laporan']?>" class="btn btn-xs btn-warning"><span class="glyphicon glyphicon-trash">edit</span></a>
